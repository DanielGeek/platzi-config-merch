...
switch (process.env.NODE_ENV) {
  ...
  case 'production':
    ...
    // REACT_APP_PAYPAL_CLIENT_ID = functions.config().google.react_app_paypal_client_id;
    // REACT_APP_GOOGLE_MAPS_API_KEY = functions.config().google.react_app_google_maps_api_key;
    break;
}
